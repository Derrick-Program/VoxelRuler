...
use oauth2::{
    AuthType, AuthUrl, AuthorizationCode, ClientId, CsrfToken,
    PkceCodeChallenge, RedirectUrl, Scope, TokenResponse, TokenUrl,
};
use oauth2::reqwest as reqwest;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    loop {
        ...
        // ✅ v5 exchange_code，傳 &http_client
        let token = client
            .exchange_code(code)
        ...
        // ✅ minecraft-msa-auth 用同一個 reqwest client
